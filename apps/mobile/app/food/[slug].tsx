...
export default function FoodDetailsScreen() {
  ...
  if (isLoading || !item) {
    return (
      <View style={{ flex: 1, backgroundColor: '#EEEEF5', alignItems: 'center', justifyContent: 'center' }}>
        <View style={{ width: 48, height: 48, borderRadius: 24, backgroundColor: '#FA793820', alignItems: 'center', justifyContent: 'center' }}>
        ...
        <View style={{
          ...
          <View style={{ flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'space-between' }}>
            ...
            <View style={{
              ...
              paddingHorizontal: 4, paddingVertical: 4, gap: 8, marginTop: 4,
            }}>
              <TouchableOpacity
                ...
                style={{
                  ...
                  backgroundColor: '#FFFFFF', alignItems: 'center', justifyContent: 'center',
                  borderWidth: 1.5, borderColor: '#D3D6DE',
                }}
              >
                <Ionicons name="remove" size={16} color="#414158" />
              </TouchableOpacity>
              <Text style={{ fontFamily: 'Urbanist-Bold', fontSize: 15, color: '#414158', minWidth: 20, textAlign: 'center' }}>
                {quantity} kg
              </Text>
              <TouchableOpacity
          ...
          <Text style={{ fontFamily: 'Urbanist', fontSize: 14, color: '#9098B1', lineHeight: 22 }}>
            {item.description ?? 'Fresh and full of flavor, perfect for healthy snacking, desserts and refreshing recipes for daily enjoyment.'}
            {'  '}
          ...
          <View style={{
            flexDirection: 'row',
            backgroundColor: '#EEEEF5', borderRadius: 14,
            padding: 4, marginTop: 20, gap: 4,
          }}>
          ...
          {/* You Might Like */}
          <Text style={{ fontFamily: 'Urbanist-SemiBold', fontSize: 16, color: '#414158', marginTop: 24, marginBottom: 14 }}>
            You Might Like
          </Text>
            ...
            {[
              ...
              <View
                ...
                style={{
                  ...
                  backgroundColor: '#EEEEF5', borderRadius: 14, padding: 8,
                }}
              >
                <Text style={{ fontSize: 30 }}>{suggestion.emoji}</Text>
                <Text style={{ fontFamily: 'Urbanist-SemiBold', fontSize: 12, color: '#414158', marginTop: 4 }}>
                  {suggestion.price}
                </Text>
              </View>
            ))}
